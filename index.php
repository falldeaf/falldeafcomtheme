    ...
    <div id="post-<?php the_ID(); ?>" class="item">
        ...
        <div id="picture_block_<?php the_ID();?>" class="picture_block">
    		...
    		<a href="<?php the_permalink(); ?>" title="<?php printf( __('Permalink to %s', 'your-theme'), the_title_attribute('echo=0') ); ?>" rel="bookmark">
   		    ...
   		    $newheight = (286 * $thumb[2] ) / $thumb[1] ?>
    		    ...
    		    <div style="height:<?=$newheight?>px; background-image:url('<?=$thumb[0]?>');"></div>
    		</a>
    	...
    	<div class="story_block cat<?=category_id_convert( get_the_category_name_without_html()  );?>_story">
				...
				<div class="story_block_links">
					<span class="cat-links"><i class="fa fa-folder-open"></i> <span class="entry-utility-prep entry-utility-prep-cat-links"><?php //_e( 'Posted in ', 'your-theme' ); ?></span><?php echo get_the_category_list(', '); ?></span>
				    <span class="meta-sep"></span>
				    <?php the_tags( '<span class="tag-links"><span class="entry-utility-prep entry-utility-prep-tag-links"><i class="fa fa-tags"></i> </span>', ", ", "</span>\n\t\t\t\t\t\t<span class=\"meta-sep\"></span>\n" ) ?>
				    <span class="comments-link"> <i class="fa fa-comments"></i> <?php comments_popup_link( __( 'Leave a comment', 'your-theme' ), __( '1 Comment', 'your-theme' ), __( '% Comments', 'your-theme' ) ) ?></span>
