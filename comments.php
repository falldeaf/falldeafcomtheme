...
<?php if ( ! empty($comments_by_type['comment']) ) : ?>
    ...
    <div id="comments-list" class="comments">
     <h2><?php printf($comment_count > 1 ? __('<span>%d</span> Comments', 'your-theme') : __('<span>One</span> Comment', 'your-theme'), $comment_count) ?></h2>
...
<?php do_action('comment_form', $post->ID); ?>
       ...
       <div class="form-submit"><input id="submit" name="submit" type="submit" value="<?php _e('Post Comment', 'your-theme') ?>" tabindex="7" /><input type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" />
