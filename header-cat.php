...
<div id="outer">
    ...
    <div id="main">
        ...
        <div id="main_head">
            ...
            <div id="image_html5_video" class="image_header_cat">
                ...
                <div id="logo" class="center logo_cat"><a href="/"><img src="<?=get_bloginfo('template_directory')?>/img/smalllogo.png" alt="My logo" title="My falldeaf logo" /></a></div>
                ...
                <div id="nav_bar">
                        <div id="button_limit">
            				...
            				foreach( $caterray as $category_array ) { ?>
                                ...
                                <div id="cat<?=$count?>text" class="hextext hextext_cat <?php if($count==1) { echo "firsthex"; } ?>">
            					...
            					<!-- <div class="nav_button <?=tab_page('cat', $category_array->name);?> cat<?=category_id_convert( $category_array->name );?> <?=$category_array->name?>" onclick="document.location='/category/<?=$category_array->slug?>/'"> 
            						<a href="/category/<?=$category_array->slug?>/"><?=$category_array->name?></a>
            					</div> -->
            				<?php $count++; } ?>
